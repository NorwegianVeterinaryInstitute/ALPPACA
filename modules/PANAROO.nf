...
process PANAROO_PANGENOME {
	...
	panaroo --version > panaroo.version
        panaroo -i $gffs -o . -t $task.cpus -a core --clean-mode $params.clean_mode --remove-invalid-genes --aligner mafft --threshold $params.identity_threshold --core_threshold $params.core_threshold --len_dif_percent $params.len_dif_percent &> panaroo_pangenome.log
        """
}
